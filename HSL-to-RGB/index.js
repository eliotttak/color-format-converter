...
async function loadDocuments(evt) {
    ...
    highLightedJS.html(await ajax("/HSL-to-RGB/main.js"))
    highLightedJS.attr("data-highlighted", "")
    highLightedTEX.html(await ajax("/HSL-to-RGB/main.tex"))
    highLightedTEX.attr("data-highlighted", "")
    highLightedPY.html(await ajax("/HSL-to-RGB/main.py"))
    highLightedPY.attr("data-highlighted", "")
    highLightedTS.html(await ajax("/HSL-to-RGB/main.ts"))
    highLightedTS.attr("data-highlighted", "")
    highLightedC.html(await ajax("/HSL-to-RGB/main.c"))
