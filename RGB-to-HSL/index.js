...
async function loadDocuments(evt) {
    ...
    highLightedJS.html(await ajax("/RGB-to-HSL/main.js"))
    highLightedJS.attr("data-highlighted", "")
    highLightedTEX.html(await ajax("/RGB-to-HSL/main.tex"))
    highLightedTEX.attr("data-highlighted", "")
    highLightedPY.html(await ajax("/RGB-to-HSL/main.py"))
    highLightedPY.attr("data-highlighted", "")
    highLightedTS.html(await ajax("/RGB-to-HSL/main.ts"))
    highLightedTS.attr("data-highlighted", "")
    highLightedC.html(await ajax("/RGB-to-HSL/main.c"))
