...
def rgb_to_hsl(r, g, b, maximums):
    """
    The function rgb_to_hsl() convert RGB colors in HSL. You can choose the value ranges in the fourth argument.
    How to use :
    rgb_to_hsl(r: number, g: number, b: number, {
        rgb: {
            r: number = 255,
            g: number = 255,
            b: number = 255
    ...
    """
    maximums["hsl"] = getattr(maximums, 'hsl', {
        "h": 360,
        "s": 100,
        "l": 100
    })
